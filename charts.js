...
function buildCharts(sample) {
  ...
  var sample_values = firstSample.sample_value;
  console.log(otuIds);
  ...
  console.log(sampleValue);
    ...
    var barLayout = {
      title: "Top 10 Bacteria Gultues Found",
      yaxis: {
        tickmode: "array",
      ...
      annotations: [{
        ...
        y: 0.25,
        yanchor: 'center',
        text: 'The bar chart displays the 10 bacterial species (OTUs)<br>with the number found in your belly button',
        showarrow: false
      }]
    };
